...
<body>
    ...
    <div class="form-wrapper">
        ...
        <div class="form-card">
            ...
            <form method="POST" action="voorstelling-wijzigen.php?id=<?= (int)$voorstelling['Id']; ?>" id="voorstelling-form">
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group">
                        ...
                        <input
                            ...
                            id="tijd"
                            name="tijd"
                            value="<?= htmlspecialchars($_POST['tijd'] ?? (isset($voorstelling['Tijd']) ? substr($voorstelling['Tijd'], 0, 5) : '')); ?>"
                            required
                        >
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <select id="beschikbaarheid" name="beschikbaarheid">
                            <option value="Ingepland" <?= (($_POST['beschikbaarheid'] ?? $voorstelling['Beschikbaarheid'] ?? 'Ingepland') === 'Ingepland') ? 'selected' : ''; ?>>Ingepland</option>
                            <option value="Uitverkocht" <?= (($_POST['beschikbaarheid'] ?? $voorstelling['Beschikbaarheid'] ?? '') === 'Uitverkocht') ? 'selected' : ''; ?>>Uitverkocht</option>
                            <option value="Geannuleerd" <?= (($_POST['beschikbaarheid'] ?? $voorstelling['Beschikbaarheid'] ?? '') === 'Geannuleerd') ? 'selected' : ''; ?>>Geannuleerd</option>
                        </select>
                    </div>
