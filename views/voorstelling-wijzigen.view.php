...
<head>
    ...
    <title>Voorstelling Wijzigen - Aurora Theater</title>
    ...
    <div class="form-wrapper">
        ...
        <div class="form-card">
                ...
                <div class="flash-db-error" id="db-error-banner" role="alert">
                    ...
                    <div class="db-error-text">
                        ...
                        <button type="button" class="btn-retry" id="btn-probeer-opnieuw"
                            onclick="document.getElementById('wijzig-form').submit();">
                            Probeer opnieuw
                        </button>
                    </div>
                </div>
            ...
            <?php if (!empty($_SESSION['flash_error'])): ?>
                <div class="flash flash-error" id="validatie-fout-melding" role="alert">
            ...
            <form method="POST"
                  action="voorstelling-wijzigen.php?id=<?= (int)$voorstelling['Id']; ?>"
                  id="wijzig-form">
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group full-width">
                        ...
                        <input
                            ...
                            value="<?= htmlspecialchars($voorstelling['Naam'] ?? ''); ?>"
                            required
                            maxlength="100"
                        >
                    </div>
                    ...
                    <div class="form-group full-width">
                        ...
                        <textarea
                            ...
                            maxlength="1000"
                        ><?= htmlspecialchars($voorstelling['Beschrijving'] ?? ''); ?></textarea>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input
                            ...
                            id="datum"
                            name="datum"
                            value="<?= htmlspecialchars($voorstelling['Datum'] ?? ''); ?>"
                            required
                        >
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input
                            ...
                            id="tijd"
                            name="tijd"
                            value="<?= htmlspecialchars(substr($voorstelling['Tijd'] ?? '', 0, 5)); ?>"
                            required
                        >
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input
                            ...
                            value="<?= htmlspecialchars($voorstelling['MaxAantalTickets'] ?? ''); ?>"
                            min="1"
                            max="9999"
                            required
                        >
                    ...
                    <div class="form-group">
                        ...
                        <select id="beschikbaarheid" name="beschikbaarheid">
                            <option value="Ingepland"   <?= (($voorstelling['Beschikbaarheid'] ?? '') === 'Ingepland')   ? 'selected' : ''; ?>>Ingepland</option>
                            <option value="Uitverkocht" <?= (($voorstelling['Beschikbaarheid'] ?? '') === 'Uitverkocht') ? 'selected' : ''; ?>>Uitverkocht</option>
                            <option value="Geannuleerd" <?= (($voorstelling['Beschikbaarheid'] ?? '') === 'Geannuleerd') ? 'selected' : ''; ?>>Geannuleerd</option>
                        </select>
                    </div>
                ...
                <div class="form-actions">
                    <a href="overzichtvoorstellingen.php" class="btn-annuleer" id="btn-annuleer-wijzigen">Annuleren</a>
